...
my_new_func = lambda person: person.split()[0] + ' ' + person.split()[-1]
#option 1
for person in people:
    print(my_new_func(person))
...
mylist2 = [number*number2 for number in range(10) for number2 in range(10)]
print(mylist2)
